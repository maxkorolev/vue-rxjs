            ...
            if (pipes && (0, _utils.isObject)(pipes)) {
                var _link = function _link(func, key) {
                    ...
                    if ((0, _utils.isFunction)(value)) {
                        ...
                        var obs = (0, _utils.isFunction)(value && value.subscribe) ? value : Rx.Observable.of(value);
                ...
                (0, _utils.forEach)(pipes, function (func, key) {
                    ...
                    // skip first null
                    vm._pipeSubs.push(subj.skip(1).subscribe(function (value) {
                    ...
                    vm._pipeSubs.push(subjOld.skip(1).subscribe(function (value) {
                        vm[propOldName(key)] = value;
                    }));

                    vm._pipeSubs.push(subjError.skip(1).filter(function (v) {
                        return !!v;
...
var getRx = exports.getRx = function getRx() {
    return Rx;
};
...
var initCombo = exports.initCombo = function initCombo(_Rx) {
    ...
    function errorIf(clause, err) {
        ...
        return Rx.Observable.merge(self.filter(clause).flatMap(function (v) {
            return Rx.Observable.throw(isFunction(err) ? err(v) : err);
    ...
    Rx.Observable.throwIf = function (cond, err) {
        return Rx.Observable.of(null).errorIf(isFunction(cond) ? cond : function () {
            return cond;
        }, err);
    };
};
